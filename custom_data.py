...
class custom_data_Classification(data.Dataset):
...
class MultiLabelDataset(Dataset):
    def __init__(self, df, split="train", transform=None, target_transform = None, base_path=None,inp_path=None):
        """
    ...
    def __getitem__(self, idx):
        ...
        return (image, img_path, self.inp), labels
